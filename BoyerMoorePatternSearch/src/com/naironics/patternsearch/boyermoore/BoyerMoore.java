package com.naironics.patternsearch.boyermoore;
...
public class BoyerMoore {
	...
	// Get right Most Index of each unique character in the pattern as a Map
	...
	public static void main(String[] args) {
		List<Integer> matches = match("ddle", "meddle riddle cuddle");
		for (Integer integer : matches)
			System.out.println("Match at: " + integer);
		System.out.println((matches.equals(Arrays.asList(2, 9, 16)) ? "OK"
				: "Failed"));
	}
}